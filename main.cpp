...
char name3[]="PROJECT:  MOBIL ANIMASI 3D";
...
{
    switch ( key )    {
     case ESCAPE : printf("Tekan escape. Keluar.\n");
...
/* Initialisation and window creation */
  ...
  glutCreateWindow("MOBIL ANIMASI 3D"); /* Open a window with a title. */
...
/* Now register the various callback functions */
  ...
  glutAddMenuEntry("Biru", 6);
 glutAddMenuEntry("Merah", 7);
 glutAddMenuEntry("Hijau",8);
 glutAddMenuEntry("Hitam",9);
 glutAddMenuEntry("Kuning",10);
 glutAddMenuEntry("coklat",11);
